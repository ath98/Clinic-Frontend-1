      ...
      <div className="container mx-auto px-4">
        <nav className="flex items-center justify-between">
          <a href="#" className="flex items-center gap-2">
            <img src={logo} alt="The Smile OS Logo" className="h-8 w-auto" />
            {/* <span className="text-xl font-bold text-blue-600">The Smile OS</span> */}
          </a>
          {/* Desktop Menu */}
          <div className="hidden md:flex items-center space-x-8">
            ...
            <a href="#contact" className="bg-blue-600 text-white px-6 py-2 rounded-full font-medium hover:bg-blue-700 transition-all duration-300 hover:shadow-lg transform hover:-translate-y-0.5">
              Book a Demo
            </a>
          </div>
          {/* Mobile Menu Button */}
        ...
        {/* Mobile Menu */}
        {isOpen && <div className="md:hidden absolute top-full left-0 right-0 bg-white shadow-lg py-4 px-4 animate-slide-up">
